...
class PasswordChangeTokenController extends AbstractController
{
	...
	public function __invoke(Request $request): JsonResponse
	{
		...
		if ($email) {
			...
			$this->getEventDispatcher()->dispatch(new PasswordResetEvent($user, $token));
			
			$this->getEntityManager()->flush();
			
			$this->getMailer()->sendPasswordResetToken($user);
		}
